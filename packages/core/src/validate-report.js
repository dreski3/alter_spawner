...
export const createValidateReport = ({ home, result, env, model, audit }) => {
  ...
  return {
    ...
    totals: { nodes: 1, succeeded: base.totals.succeeded, tokens: base.totals.tokens, node_duration_ms: base.totals.reviewer_duration_ms, estimated_api_cost_usd: base.totals.estimated_api_cost_usd },
    designer,
    audit,
  };
};
